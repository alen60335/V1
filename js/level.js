...
const Level = (() => {
  ...
  const spawns = {
    player: { x: 5, floor: 32 },
    signs: [
      { x: 8,  floor: 32, text: '←→／A D 移動，Space 跳躍，F 法杖揮擊。' },
      { x: 17, floor: 32, text: '按 1火 2水 3風 4土 輸入元素，Enter 起陣。同元素不能相鄰；被克元素不能接續（水克火・土克水・風克土・火克風）。序列首尾必須接成圓。' },
      { x: 26, floor: 32, text: '速成陣式——「1 4」火土＝火種（燃燒地帶）；「3 2」風水＝流體位移。按 Tab 查看全部陣式。' },
