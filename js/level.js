...
const Level = (() => {
  ...
  const spawns = {
    player: { x: 5, floor: 32 },
    signs: [
      { x: 8,  floor: 32, text: '←→ 移動，Space／↑ 跳躍，X 法杖揮擊。' },
      { x: 17, floor: 32, text: '按 A火 S水 D風 F土 輸入元素，Enter 起陣。同元素不能相鄰；被克元素不能接續（水克火・土克水・風克土・火克風）。序列首尾必須接成圓。' },
      { x: 26, floor: 32, text: '速成陣式——「A F」火土＝火種（燃燒地帶）；「D S」風水＝流體位移。按 Tab 查看全部陣式。' },
      { x: 44, floor: 32, text: '速陣快而弱，強陣強而慢。施展窗口越長，越容易被人破陣。' },
      { x: 76, floor: 32, text: '結界擋路！破陣＝把對方每個元素換成克制它的元素。此陣為 土→火；風克土、水克火，故破陣序列為「風 水」。站到結界前，按住 Shift 輸入 D、S，再按 Shift+Enter。' },
